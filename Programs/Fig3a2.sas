*--- Goal: Cox regression for major chronic diseases. Subgroup by coffee.
;
...
----------------------------------------
coffv          1.7412500       1.8518878
coff           1.0700000       1.7331084
----------------------------------------;
...
%indic3(vbl=regibui,     prefix=regibui,    min=2, max=2, reflev=1, usemiss=0);
  ...
  array newgg {*} coffrcediha coffrcedipa coffcaheia coffcameda coffcdasha coffchpdia coffcdrsa coffcwcrfa coffcaheioa coffcamedoa coffcwcrfoa coffrcedihoa coffrcedipoa;

  do i=1 to dim(orig);
      if coffv<2 then newgg{i}=orig{i};
      else if coffv>=2 then newgg{i}=0;
  end;

  if coffv<2 then lowcoff=1;
  else lowcoff=0;
run;

title '----- Interaction: Pattern * Coffee (binary) -----';
...
model1=caheiaa    coffcaheia   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff,
model2=camedaa    coffcameda   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff,
model3=chpdiaa    coffchpdia   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_,
model4=cdashaa    coffcdasha   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_, 
model5=cdrsaa     coffcdrsa    &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_,
model6=cwcrfaa    coffcwcrfa   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff,
model7=rcedihaa   coffrcediha  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff,
model8=rcedipaa   coffrcedipa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff,
model9=caheioaa   coffcaheioa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_,
model10=camedoaa  coffcamedoa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_, 
model11=cwcrfoaa  coffcwcrfoa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_,
model12=rcedihoaa coffrcedihoa &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_, 
model13=rcedipoaa coffrcedipoa &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowcoff &alcog_
);
data outdata1;
set outdata1;
if index(variable,'coff');
...
ods csv file='./coff_Waldpvalues.csv';
proc print data=outdata1 noobs;run;
ods csv close;

title '----- Subgroup: coffee -----';
...
%all_cox(where=coffv lt 2,name=lowcoff);
%all_cox(where=coffv ge 2,name=highcoff);

data result;
set all_lowcoff all_highcoff;
run;

ods csv file='./coff_subgrp.csv';
proc print data=result noobs;run;
ods csv close;

title '---------- case no. & person-yr ----------';
proc freq data=pooled;
tables lowcoff*chrv/norow nocol nopercent missing;
run;

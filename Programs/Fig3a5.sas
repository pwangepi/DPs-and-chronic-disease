*--- Goal: Cox regression for major chronic diseases. Subgroup by sex.
;
...
%indic3(vbl=sex,         prefix=sex,        min=0, max=0, reflev=1, usemiss=0);
  ...
  array newgg {*} sexrcediha sexrcedipa sexcaheia sexcameda sexcdasha sexchpdia sexcdrsa sexcwcrfa sexcaheioa sexcamedoa sexcwcrfoa sexrcedihoa sexrcedipoa;

  do i=1 to dim(orig);
      if cohort in (1,2) then newgg{i}=orig{i};
      else newgg{i}=0;
  end;
run;

title '----- Interaction: Pattern * Sex (binary) -----';
...
id=id, agevar=agemo,strata=agemo periodnew, 
model1=rcedihaa   sexrcediha &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4,
model2=rcedipaa   sexrcedipa &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4,
model3=caheiaa    sexcaheia  &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4,
model4=camedaa    sexcameda  &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4,
model5=cdashaa    sexcdasha  &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_, 
model6=chpdiaa    sexchpdia  &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_,
model7=cdrsaa     sexcdrsa   &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_,
model8=cwcrfaa    sexcwcrfa  &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4,
model9=caheioaa   sexcaheioa &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_,
model10=camedoaa  sexcamedoa &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_, 
model11=cwcrfoaa  sexcwcrfoa &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_,
model12=rcedihoaa sexrcedihoa &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_, 
model13=rcedipoaa sexrcedipoa &sex_ &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 &alcog_
);
data outdata1;
set outdata1;
if index(variable,'sex');
...
ods csv file='./sex_Waldpvalues.csv';
proc print data=outdata1 noobs;run;
ods csv close;

title '----- Subgroup: sex -----';
%macro cox(exp=,where=,name=)/minoperator;
%if &name in men %then %do;
    %if &exp in cdasha chpdia cdrsa rcedihoa rcedipoa caheioa camedoa cwcrfoa  %then %do; 
        %let cov=&fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ &alcog_;
    %end;
    %else %do;
        %let cov=&fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_;
    %end;
%end;

%if &name in women %then %do;
    %if &exp in cdasha chpdia cdrsa rcedihoa rcedipoa caheioa camedoa cwcrfoa  %then %do; 
...
qret=irt84 irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14, 
timevar=t84 t86 t88 t90 t92 t94 t96 t98 t00 t02 t04 t06 t08 t10 t12 t14,
id=id, agevar=agemo,strata=agemo periodnew, where=&where,
model1=&exp.a, 
model2=&exp.a sesa,
model4=&exp.a &cov,
...
%all_cox(where=cohort eq 3,name=men);
%all_cox(where=cohort ne 3,name=women);

data result;
set all_men all_women;
run;

ods csv file='./sex_subgrp.csv';
proc print data=result noobs;run;
ods csv close;

title '---------- case no. & person-yr ----------';
proc freq data=pooled;
tables cohort*chrv/norow nocol nopercent missing;
run;

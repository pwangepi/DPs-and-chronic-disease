...
%mphreg9(data=pooled, dtdx=dt_totstr, event=tot_strv, dtdth=dtdeath, cutoff=cutoff, tvar=periodnew, outdat=est_&exp.,
...
ods csv file='./est_str.csv';
proc print data=all noobs;run;
ods csv close;

title '----- PH assumption -----';
    %mphreg9(data=pooled, dtdx=dt_totstr, event=tot_strv, dtdth=dtdeath, cutoff=cutoff, tvar=periodnew, outdat=pooled_ph1,
    qret=irt84 irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14, 
    timevar=t84 t86 t88 t90 t92 t94 t96 t98 t00 t02 t04 t06 t08 t10 t12 t14,
    id=id, agevar=agemo,strata=agemo periodnew cohort, 
...
ods csv file='./ph_str.csv';
proc print data=pooled_ph1 noobs;run;
ods csv close;

title '----- BMI, coffee -----';
    %mphreg9(data=pooled, dtdx=dt_totstr, event=tot_strv, dtdth=dtdeath, cutoff=cutoff, tvar=periodnew, outdat=sens,
    qret=irt84 irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14, 
    timevar=t84 t86 t88 t90 t92 t94 t96 t98 t00 t02 t04 t06 t08 t10 t12 t14,
    id=id, agevar=agemo,strata=agemo periodnew cohort, 
...
tables (qcaheia qcameda qchpdia qcdasha qcdrsa qcwcrfa qrcediha qrcedipa 
        qcaheioa qcamedoa qcwcrfoa qrcedihoa qrcedipoa)*tot_strv/norow nocol nopercent missing;
run;

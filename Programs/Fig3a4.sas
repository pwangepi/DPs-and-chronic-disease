*--- Goal: Cox regression for major chronic diseases. Test if SES changes the results.
;
...
%indic3(vbl=regibui,     prefix=regibui,    min=2, max=2, reflev=1, usemiss=0);
  ...
  array newgg {*} sesrcediha sesrcedipa sescaheia sescameda sescdasha seschpdia sescdrsa sescwcrfa sescaheioa sescamedoa sescwcrfoa sesrcedihoa sesrcedipoa;

  do i=1 to dim(orig);
      if ses<-0.3813207 then newgg{i}=orig{i};
      else if ses>=-0.3813207 then newgg{i}=0;
  end;

  if ses<-0.3813207 then lowses=1;
  else lowses=0;
run;


title '----- Interaction: Pattern * SES (binary) -----';
...
model1=caheiaa    sescaheia   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses,
model2=camedaa    sescameda   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses,
model3=chpdiaa    seschpdia   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_,
model4=cdashaa    sescdasha   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_, 
model5=cdrsaa     sescdrsa    &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_,
model6=cwcrfaa    sescwcrfa   &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses,
model7=rcedihaa   sesrcediha  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses,
model8=rcedipaa   sesrcedipa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses,
model9=caheioaa   sescaheioa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_,
model10=camedoaa  sescamedoa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_, 
model11=cwcrfoaa  sescwcrfoa  &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_,
model12=rcedihoaa sesrcedihoa &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_, 
model13=rcedipoaa sesrcedipoa &fmdiab_ &cafhx_ &fmcvd_ &actg_ &cigg_ &pkyrg_ &mvyn_ &regasp_ &regibui_ &qccalor_ pmhsex2 pmhsex3 pmhsex4 lowses &alcog_
);
data outdata1;
set outdata1;
if index(variable,'ses');
...
ods csv file='./ses_Waldpvalues.csv';
...
%all_cox(where=ses lt -0.3813207,name=lowses);
%all_cox(where=ses ge -0.3813207,name=highses);

data result;
set all_lowses all_highses;
run;

ods csv file='./ses_subgrp.csv';
...
tables lowses*chrv/norow nocol nopercent missing;
run;
